package com.yb.core.view.toast;
...
public class Toasty {
    ...
    public static Toast normal(@NonNull Context context, @StringRes int message, int duration,
        ...
        return custom(context, context.getString(message), icon, ToastyUtils.getColor(context, R.color.ybcp_normalColor),
                ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor), duration, withIcon, true);
    }

    @CheckResult
    public static Toast normal(@NonNull Context context, @NonNull CharSequence message, int duration,
                               Drawable icon, boolean withIcon) {
        return custom(context, message, icon, ToastyUtils.getColor(context, R.color.ybcp_normalColor),
                ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor), duration, withIcon, true);
    }
    ...
    public static Toast warning(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ybcp_ic_error_outline_white_24dp),
                ToastyUtils.getColor(context, R.color.ybcp_warningColor), ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor),
    ...
    public static Toast warning(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.ybcp_ic_error_outline_white_24dp),
                ToastyUtils.getColor(context, R.color.ybcp_warningColor), ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ybcp_ic_info_outline_white_24dp),
                ToastyUtils.getColor(context, R.color.ybcp_infoColor), ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast info(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.ybcp_ic_info_outline_white_24dp),
                ToastyUtils.getColor(context, R.color.ybcp_infoColor), ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ybcp_ic_check_white_24dp),
                ToastyUtils.getColor(context, R.color.ybcp_successColor), ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast success(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.ybcp_ic_check_white_24dp),
                ToastyUtils.getColor(context, R.color.ybcp_successColor), ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ybcp_ic_clear_white_24dp),
                ToastyUtils.getColor(context, R.color.ybcp_errorColor), ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast error(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.ybcp_ic_clear_white_24dp),
                ToastyUtils.getColor(context, R.color.ybcp_errorColor), ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, -1, ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               int duration, boolean withIcon) {
        return custom(context, message, icon, -1, ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor),
                duration, withIcon, false);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, @DrawableRes int iconRes,
        ...
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, iconRes),
                ToastyUtils.getColor(context, tintColorRes), ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor),
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, ToastyUtils.getColor(context, tintColorRes),
                ToastyUtils.getColor(context, R.color.ybcp_defaultTextColor), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        final View toastLayout = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE))
                .inflate(R.layout.ybcp_toast_layout, null);
        ...
        if (shouldTint)
            ...
            drawableFrame = ToastyUtils.getDrawable(context, R.mipmap.ybcp_toast_frame);
